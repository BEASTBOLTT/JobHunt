    ...
    <main>
        <div className='h-screen flex flex-col justify-center items-center'>
            <div className='border rounded-2xl w-[35vw]'>
                  <h1 className='ml-11 text-4xl mt-10'>Login</h1>
                  ...
                  <p className='m-12 mt-4'>Don't have an account ? <Link to={"/register"} className='font-bold text-blue-300 hover:text-red-500'>Register</Link></p>
            </div>
        </div>
    </main>
  )
